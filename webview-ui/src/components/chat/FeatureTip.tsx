...
const FEATURE_TIPS: FeatureTipItem[] = [
	{
		text: 'Enable "Double-Check Completion" in settings to have GenCoder verify its work before finishing a task.',
	},
	{
		text: "Add a .clinerules file to your project root to give GenCoder project-specific instructions.",
	},
	{
		text: "Switch to Plan Mode to discuss and plan an approach before GenCoder takes action.",
	},
	{
		text: "Use @ in the chat input to add files, folders, or URLs as context for your task.",
	},
	{
		text: "Set up MCP Servers to give GenCoder access to external tools and APIs.",
	},
	{
	...
	{
		text: "Use the quote button to select text from GenCoder's response and reference it in your reply.",
	},
	{
		text: "You can drag and drop images into the chat to share screenshots with GenCoder.",
	},
	{
		text: "GenCoder can browse websites — ask it to test your local dev server in the browser.",
	},
	{
 ...
 * Appears after a brief delay and cycles through tips while GenCoder is thinking.
 */
